...
for i in ele:
    ...
    get_value_start = module.get_parameter_value_by_name(i, "Start Level Offset", is_UTF8 = False)
    to_mm_start = float(get_value_start)/304.8
    set_param_start = module.set_parameter_value_by_name(i, "Start Level Offset", H_projection_start + to_mm_start, is_UTF8 = False)
    ...
    get_value_end = module.get_parameter_value_by_name(i, "End Level Offset", is_UTF8 = False)
    to_mm_end = float(get_value_end)/304.8
    set_param_end = module.set_parameter_value_by_name(i, "End Level Offset",H_projection_end + to_mm_end, is_UTF8 = False)
    # allow_join_at_end(i)
