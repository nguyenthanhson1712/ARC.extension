...
try:
    ...
    for i in Ele:
        ...
        set_para_value_start = module.set_parameter_value_by_name(i, "Start Level Offset", (float(get_para_value_start) + float(gia_tri_dieu_chinh))/304.8, is_UTF8 = False)
        set_para_value_end = module.set_parameter_value_by_name(i, "End Level Offset", (float(get_para_value_end) + float(gia_tri_dieu_chinh))/304.8, is_UTF8 = False)
    t.Commit()
except:
    pass